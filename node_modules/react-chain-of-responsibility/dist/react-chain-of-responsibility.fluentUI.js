...
function createChainOfResponsibility(options = {}) {
  ...
  const Proxy2 = (0, import_react.memo)(
  ...
  Proxy2.displayName = "Proxy";
  Proxy2.propTypes = {
    fallbackComponent: import_prop_types.default.any,
    request: import_prop_types.default.any
  };
  return {
    Provider,
    Proxy: Proxy2,
...
function createChainOfResponsibilityForFluentUI(options) {
  ...
  const useBuildRenderFunction = (options2 = {}) => {
    ...
    return (0, import_react2.useCallback)(
      (props, defaultRender) => /* @__PURE__ */ import_react2.default.createElement(Proxy2, { ...props, fallbackComponent: defaultRender, key: getKey == null ? void 0 : getKey(props), request: props }),
      [getKey]
    );
  };
