...
export type DebouncedNotifications = {
    [id: string]: DebouncedNotification;
};
declare function getEarliestUpdateNotBefore(notificationMap: DebouncedNotifications): number;
...
//# sourceMappingURL=useDebouncedNotifications.d.ts.map