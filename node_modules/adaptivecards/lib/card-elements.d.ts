 ...
 */
export declare class ChoiceSetInputDataQuery extends SerializableObject {
...
export declare type FetchedChoice = {
    title: string;
    value: string;
};
...
export declare class FilteredChoiceSet {
    private _parent?;
...
export declare abstract class UniversalAction extends SubmitActionBase {
}
export declare class ExecuteAction extends UniversalAction {
    static readonly JsonTypeName: "Action.Execute";
    static readonly verbProperty: StringProperty;
    verb: string;
    getJsonTypeName(): string;
}
export declare class DataQuery extends UniversalAction {
